...
func (db *DB) migrateSQLite(ctx context.Context) error {
	statements := []string{
		`CREATE TABLE IF NOT EXISTS accounts (
			...
			usage_reserve_percent_5h INTEGER NULL,
			usage_reserve_percent_7d INTEGER NULL,
		...
		`CREATE TABLE IF NOT EXISTS system_settings (
				...
				models_list_read_max_bytes INTEGER NOT NULL DEFAULT 8388608,
					...
					codex_fast_model_alias_enabled INTEGER DEFAULT 1,
					codex_reasoning_effort_alias_enabled INTEGER DEFAULT 1,
					codex_fast_tier_intercept_enabled INTEGER DEFAULT 0,
					codex_force_fast_enabled INTEGER DEFAULT 0,
	...
	columns := []struct {
		...
		{"accounts", "usage_reserve_percent_5h", "INTEGER NULL"},
		{"accounts", "usage_reserve_percent_7d", "INTEGER NULL"},
		...
		{"system_settings", "codex_fast_model_alias_enabled", "INTEGER DEFAULT 1"},
		{"system_settings", "codex_reasoning_effort_alias_enabled", "INTEGER DEFAULT 1"},
		{"system_settings", "codex_fast_tier_intercept_enabled", "INTEGER DEFAULT 0"},
		{"system_settings", "codex_force_fast_enabled", "INTEGER DEFAULT 0"},
