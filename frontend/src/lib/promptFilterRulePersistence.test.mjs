...
const promptFilterSource = readSource(new URL('../pages/PromptFilter.tsx', import.meta.url))
const settingsSource = readSource(new URL('../pages/Settings.tsx', import.meta.url))
