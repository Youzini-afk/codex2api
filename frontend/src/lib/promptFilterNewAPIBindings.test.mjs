...
const componentSource = readSource(new URL('../components/PromptFilterNewAPIBindings.tsx', import.meta.url))
const pageSource = readSource(new URL('../pages/PromptFilter.tsx', import.meta.url))
const apiSource = readSource(new URL('../api.ts', import.meta.url))
