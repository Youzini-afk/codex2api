...
For Zeabur, see `.env.zeabur.example`. The service also reads `DATABASE_URL`, `POSTGRES_CONNECTION_STRING`, `REDIS_URL`, `REDIS_CONNECTION_STRING`, and common Zeabur split environment variables.
